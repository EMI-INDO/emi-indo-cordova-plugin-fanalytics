...
- [ ] I have reproduced the issue using the [example project](https://github.com/EMI-INDO/emi-indo-cordova-plugin-fanalytics/blob/main/example/index.html) or provided the necessary information to reproduce the issue.
<!-- necessary information e.g. exact steps, FCM notification message content, test case project repo -->

- [ ] I have read [the documentation](https://github.com/EMI-INDO/emi-indo-cordova-plugin-fanalytics/blob/main/README.md) thoroughly and it does not help solve my issue.
